...
class ClientListCreateAPIView(APIView):
    ...
    def get(self, request):
        ...
        queryset = Client.objects.select_related('municipality', 'municipality__department', 'created_by').order_by('id')
...
class ClientDetailAPIView(APIView):
    ...
    def get_object(self, client_id):
        try:
            return Client.objects.select_related('municipality', 'municipality__department', 'created_by').get(pk=client_id)
