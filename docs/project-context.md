...
Modulo implementado:
- Paquetes turistico con destino, detalles por tipo de servicio y eliminacion logica.
- Los detalles del paquete se sincronizan desde el API para poder agregar, editar o quitar servicios.
