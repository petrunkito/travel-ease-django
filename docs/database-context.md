...
- En PaqueteTuristico, un update puede reemplazar el conjunto de DetallePaquete para agregar o quitar servicios, pero cada detalle debe conservar PrecioUnitario y Total como snapshot del momento de armado.
